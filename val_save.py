...
if __name__ == "__main__":
    ...
    def write_result(res):
        model_dir = '/amax/home/dzr/dzr/dzr/autoCalib/Mine/visual-paper/val_hsi_real/val_eval/'
    ...
    for i, name in enumerate(load_net_name_list):
        ...
        model_save_dir = '/amax/home/dzr/dzr/dzr/autoCalib/Mine/visual-paper/val_hsi_real/'+method_name+'/'
        if not os.path.isdir(model_save_dir):
            os.makedirs(model_save_dir, exist_ok=True)
        generator = utils.create_generator_val1(opt,name).cuda()
        demo_dataset = dataset.HS_multiscale_DSet(opt,'val')
